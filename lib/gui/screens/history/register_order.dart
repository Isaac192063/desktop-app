...
//   Map<String, Packaging> productMap = {};
...
//     super.initState();
//     listPackaging = _productController.getAllProduct();
//   }
...
//                                   supplier: productMap[selectedProduct]!.supplier);
//                               setState(() {
...
//         child: fluent_ui.SingleChildScrollView(
//           child: fluent_ui.SizedBox(
//             width: fluent_ui.MediaQuery.of(context).size.width,
//             child: DataTable(
//               // headingRowColor: ,
//               dataRowHeight: 40,
//               columnSpacing: 2,
