...
class IndexOrderRecepcion extends StatefulWidget {
  const IndexOrderRecepcion({Key? key}) : super(key: key);

  @override
  State<IndexOrderRecepcion> createState() => _IndexOrderState();
}

class _IndexOrderState extends State<IndexOrderRecepcion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Registro de Recepciones"),
          bottom: AppBar(
            automaticallyImplyLeading: false,
